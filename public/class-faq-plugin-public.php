...
class faq_plugin_Public
{
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_style($this->faq_plugin, plugin_dir_url(__FILE__).'css/faq-plugin-public.css', [], $this->version, 'all');
    }
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_script($this->faq_plugin, plugin_dir_url(__FILE__).'js/faq-plugin-public.js', ['jquery'], $this->version, false);
    }
}
